        ...
        <div className={`header-navbar ${isBlurred ? '' : 'no-blur'} ${isSliding ? 'navbar-slide-up' : ''} ${isHome ? 'navbar-home' : 'navbar-other'}`}>
            ...
            <div className="desktop-menu">
                <nav className="menu-items" >
                    <Link to="/projectsHome" className="menu-link-desktop projects"  style={{ color: iconColor }}>Projects</Link>
                    <Link to="/awardsandpress" className="menu-link-desktop press-awards"  style={{ color: iconColor }}>Press & Awards</Link>
                    <Link to="/studio" className="menu-link-desktop studio"  style={{ color: iconColor }}>Studio</Link>
                    <Link to="/contact" className="menu-link-desktop contact"  style={{ color: iconColor }}>Contact</Link>
                </nav>
            </div>
