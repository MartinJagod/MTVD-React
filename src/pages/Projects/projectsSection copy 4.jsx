...
const sectionRanges = {
  ...
  return (
    <div className="projects-section">
     ...
     <div className=" section-selector-projects desktop-menu-projetcs">
  <nav className="menu-items-split-desktop">
    <div className="menu-left-projects">
      {['Design', 'Architecture', 'Branding'].map((sec) => (
        <button
          key={sec}
          className={`menu-link-desktop-section ${section === sec ? 'active' : ''}`}
...
{/* 
          <Link to="/projects" className=" desktop-hide filter-selector">
             {lang === 'ES' ? 'Todos' : 'All'}
          </Link> */}
        </div>
